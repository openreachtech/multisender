...
describe("GasMeter", function () {
  ...
  async function deployGasMeterFixture() {
    ...
    const [minter, recepient1, recepient2, recepient3, recepient4, recepient5, recepient6, recepient7] = await ethers.getSigners();
    ...
    return { erc20, meter, minter, recepient1, recepient2, recepient3, recepient4, recepient5, recepient6, recepient7 };
  }

  describe("mesureERC20Transfer", function () {
    it("mesure gas cost of erc20 transfer", async function () {
      const { erc20, meter, minter, recepient1, recepient2, recepient3, recepient4, recepient5, recepient6, recepient7 } = await loadFixture(
        deployGasMeterFixture
      );
